...
cc -DPLATFORM_PC -Iinclude pc_game_loop_test.c build/pc/file.o build/pc/input.o build/pc/time.o build/pc/dvdmgr_pc.o build/pc/arcdrv_pc.o build/pc/mapdrv_pc.o build/pc/msgdrv_pc.o build/pc/game_loop_pc.o build/pc/render_pc.o -o build/pc/game_loop_test
